...
export class ValorantV1ByPuuidLifetimeMatchesAffinityPuuidGet501Response {
    'status'?: number;
    ...
    static getAttributeTypeMap() {
        return ValorantV1ByPuuidLifetimeMatchesAffinityPuuidGet501Response.attributeTypeMap;
    }
